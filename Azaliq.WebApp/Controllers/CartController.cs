...
namespace Azaliq.WebApp.Controllers
{
    ...
    public class CartController : BaseController
    {
        ...
        public async Task<IActionResult> UpdateAndCheckout(List<CartItemViewModel> Items)
        {
            ...
            // Otherwise update quantities and redirect
